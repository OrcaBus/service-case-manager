...
from app.schemas.events.models import CaseExternalEntityRelationshipChange, Action, DetailType
from app.serializers import CaseSerializer
from app.serializers import ExternalEntitySerializer


@transaction.atomic
def link_case_to_external_entity_and_emit(case: Case, external_entity: ExternalEntity,
                                          added_via: str = "manual") -> CaseExternalEntityLink:
    """
    ...
    external_entity_data = ExternalEntitySerializer(case_entity_link.external_entity).data
    ...
    emit_event(detail_type=DetailType.CaseEntityRelationshipStateChange.value, event_detail_model=relationship_change_event)
    return case_entity_link


@transaction.atomic
def unlink_case_to_external_entity_and_emit(case_external_entity: CaseExternalEntityLink) -> CaseExternalEntityLink:
    """
    ...
    external_entity_data = ExternalEntitySerializer(case_external_entity.external_entity).data
